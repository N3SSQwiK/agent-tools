...
3. For each runnable task:
   ...
   c. Build task handoff using Spoke Contract template (see `templates/task-handoff.md`)
...
See `templates/task-handoff.md` for the full handoff template sent to spokes.
