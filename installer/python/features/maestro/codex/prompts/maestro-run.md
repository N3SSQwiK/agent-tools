...
Execute approved Maestro orchestration plan or a specific task.
...
If a spoke returns a `permission_denials` response, the hub MAY extract the file paths and content and write files directly as a fallback.
