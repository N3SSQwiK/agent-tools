...
The Nexus-AI installer is a TUI application that configures AI coding assistant CLI tools (Claude Code, Gemini CLI, Codex CLI) with shared features. It handles feature discovery, command installation, and configuration merging.
