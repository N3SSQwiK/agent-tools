...
- [ ] **2.1** Update Claude command (`features/continuity/claude/commands/continuity.md`)
...
- [ ] **2.2** Update Gemini extension (`features/continuity/gemini/extensions/continuity/commands/continuity.toml`)
  - Change read/write path to `.ai/CONTINUITY.md`
  - Implement expanded ~500 token format with all sections
  - Add migration check for `.gemini/CONTINUITY.md`
  - Validation: Manual test with `/continuity` command

- [ ] **2.3** Update Codex prompt (`features/continuity/codex/prompts/continuity.md`)
  - Change read/write path to `.ai/CONTINUITY.md`
  - Implement expanded ~500 token format with all sections
...
- [ ] **3.1** Update README if continuity feature is documented
...
- [ ] All three tools reference `.ai/CONTINUITY.md` in global instructions
- [ ] All three slash commands read/write to unified path
- [ ] Expanded format includes all 8 sections
- [ ] Suggested Prompt section is actionable and copy-pasteable
- [ ] Total token count is approximately 500 tokens
- [ ] Migration prompts work for each legacy path
- [ ] New installs create `.ai/CONTINUITY.md` correctly
- [ ] Existing installs are prompted to migrate
